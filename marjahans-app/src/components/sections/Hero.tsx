        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="space-y-10">
            ...
            >
              ...
              <Badge className="bg-primary text-black font-black px-4 py-1.5 rounded-sm animate-bounce shadow-[0_0_20px_rgba(212,175,55,0.5)]">
                NEW COLLECTION
              </Badge>
            ...
            <div className="relative group">
              <motion.h1
                ...
                className="text-6xl sm:text-7xl lg:text-8xl xl:text-9xl font-display font-black text-white leading-[1] tracking-normal"
              >
                WHERE <br />
                <span className="text-primary italic font-serif">LUXURY</span> <br />
                <span className="text-white/80 text-4xl sm:text-5xl lg:text-6xl tracking-tight">MEETS AFFORDABILITY.</span>
              </motion.h1>

              {/* Decorative text */}
              <div className="absolute -top-10 -left-10 text-[10vw] font-black text-white/5 pointer-events-none select-none -z-10 uppercase">
                MARJAHAN'S
              </div>
            </div>
            ...
            >
              Explore handcrafted heirloom pieces, exquisite rings, and exclusive collections designed for modern elegance.
            </motion.p>
            ...
            >
              {[
                { icon: Truck, text: 'Secure Shipping', sub: 'Nationwide' },
                { icon: Shield, text: 'Certified Quality', sub: 'Authentic Gold' },
                { icon: Clock, text: 'Bespoke Support', sub: '24/7 Concierge' },
              ].map((badge) => (
            ...
            >
              ...
              >
                ...
                <picture>
                  ...
                  <img
                    src="https://images.unsplash.com/photo-1599643477877-530970AB0D14?auto=format&fit=crop&q=80&w=800"
                    alt="Marjahan's Premium Jewelry"
                    loading="eager"
                    fetchPriority="high"
