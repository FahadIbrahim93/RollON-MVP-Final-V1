        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-12 xl:px-20">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-white mb-6">
              About <span className="gradient-text">Marjahan's</span>
            </h1>
            <p className="text-lg text-white/60 leading-relaxed">
              Founded in 2020, Marjahan's has grown to become Bangladesh&apos;s premier destination for premium smoking accessories. We believe in elevating experiences through quality products and exceptional service.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-6">
              At Marjahan's, our mission is simple: to provide enthusiasts with access to the world&apos;s finest smoking accessories. We carefully curate our collection to ensure every product meets our exacting standards of quality, design, and functionality.
            </p>
          ...
          >
            <div className="aspect-square bg-gradient-to-br from-green-400/20 to-cyan-400/20 rounded-3xl flex items-center justify-center">
              <div className="text-center">
                <div className="text-6xl font-display font-bold gradient-text mb-4">Marjahan's</div>
