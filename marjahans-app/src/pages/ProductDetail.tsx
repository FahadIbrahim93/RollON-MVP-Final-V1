...
export function ProductDetail() {
  ...
  const seoDescription = useMemo(() => {
    if (!product) {
      return `Premium smoking accessories from Marjahan's Bangladesh.`;
    }
