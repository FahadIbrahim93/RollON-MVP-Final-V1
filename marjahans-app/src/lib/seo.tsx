...
const SITE_URL = 'https://marjahans.com.bd';
...
export function useDocumentSEO({
  ...
  useEffect(() => {
    ...
    const schemaId = 'marjahans-jsonld';

    document.title = `${title} | Marjahan's Bangladesh`;

    upsertMetaTag('meta[name="description"]', { name: 'description', content: description });
    upsertMetaTag('meta[name="keywords"]', { name: 'keywords', content: keywords });
    upsertMetaTag('meta[property="og:title"]', { property: 'og:title', content: `${title} | Marjahan's Bangladesh` });
    ...
    upsertMetaTag('meta[name="twitter:title"]', { name: 'twitter:title', content: `${title} | Marjahan's Bangladesh` });
