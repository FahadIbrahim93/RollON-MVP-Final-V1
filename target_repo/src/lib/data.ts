...
export const testimonials: Testimonial[] = [
  {
    ...
    name: 'Rahman Ahmed',
    rating: 5,
    text: 'Amazing quality products! The grinder I ordered exceeded my expectations. Fast delivery in Dhaka and excellent customer service.',
    date: '2026-02-15'
  },
  {
    id: '2',
    name: 'Sarah Khan',
    rating: 5,
    text: 'Best smoking accessories shop in Bangladesh. Love the variety and the prices are reasonable. The vaporizer works perfectly!',
    date: '2026-02-10'
  },
  {
    id: '3',
    name: 'Imran Hossain',
    rating: 4,
    text: 'Great experience shopping here. The bKash payment was smooth and I got my order the next day. Will definitely order again.',
    date: '2026-01-28'
  },
  {
    id: '4',
    name: 'Nadia Islam',
    rating: 5,
    text: 'The silicone water pipe is unbreakable as advertised! Perfect for parties. Thanks RollON for the quality products.',
    date: '2026-01-20'
  },
  {
    id: '5',
    name: 'Kamal Hassan',
    rating: 5,
    text: 'Been buying from RollON for months now. Always satisfied with the products and delivery. Highly recommended!',
    date: '2026-01-15'
  }
];
...
export const orders: Order[] = [
  {
    ...
    items: [
      { productId: '1', name: 'Classic Design Four-Layer Aluminium Grinder', price: 1200, quantity: 1, image: '/images/grinder-aluminium.jpg' }
    ],
    total: 1200,
    status: 'delivered',
  ...
  },
  {
    ...
    items: [
      { productId: '3', name: 'Premium Dry Herb Vaporizer', price: 7200, quantity: 1, image: '/images/vaporizer-dry-herb.jpg' },
      { productId: '4', name: 'OCB Organic Hemp Rolling Papers', price: 250, quantity: 2, image: '/images/papers-ocb.jpg' }
    ],
    total: 7700,
    status: 'processing',
    paymentStatus: 'completed',
  ...
  },
  {
    ...
    items: [
      { productId: '6', name: 'Clipper Refillable Lighter', price: 450, quantity: 3, image: '/images/lighter-clipper.jpg' }
    ],
    total: 1350,
    status: 'shipped',
    paymentStatus: 'completed',
  ...
  },
  {
    ...
    items: [
      { productId: '8', name: '5 Inch Mini Silicone Water Pipe', price: 1750, quantity: 1, image: '/images/bong-mini-silicone.jpg' },
      { productId: '5', name: 'RAW Classic King Size Slim', price: 180, quantity: 5, image: '/images/papers-raw.jpg' }
    ],
    total: 2650,
    status: 'pending',
  ...
  },
  {
    ...
    items: [
      { productId: '9', name: 'Zippo Classic Windproof Lighter', price: 3500, quantity: 1, image: '/images/lighter-zippo.jpg' }
    ],
    total: 3500,
    status: 'delivered',
    paymentStatus: 'completed',
