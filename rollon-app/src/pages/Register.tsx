              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    {...register('name')}
                    type="text"
                    className={`w-full pl-12 pr-4 py-3 bg-white/5 border rounded-xl text-white placeholder:text-white/30 focus:outline-none transition-colors ${errors.name ? 'border-red-500 focus:border-red-500' : 'border-white/10 focus:border-green-400/50'}`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type={showPassword ? 'text' : 'password'}
                    className={`w-full pl-12 pr-4 py-3 bg-white/5 border rounded-xl text-white placeholder:text-white/30 focus:outline-none transition-colors ${errors.confirmPassword ? 'border-red-500 focus:border-red-500' : 'border-white/10 focus:border-green-400/50'}`}
                    placeholder="••••••••"
                  />
                </div>
